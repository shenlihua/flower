    ...
    <div style="background:#f5f5f5;padding:20px;position:relative">
        ...
        <div>
            <form action="" method="post" id="form">
                <div class="form-group">
                    <input type="text" class="form-control" name="user" placeholder="登录名" value="<?php echo (cookie('user')); ?>" required="required">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control" name="pwd" placeholder="口令" value="<?php echo (cookie('password')); ?>" required="required">
                </div>
...
function checkSubmit() {
    $.ajax({
        url: "<?php echo U('Login/loginAction');?>",
        type: "POST",
        data: $('#form').serialize(),
        dataType: "text",
        success: function(re) {
