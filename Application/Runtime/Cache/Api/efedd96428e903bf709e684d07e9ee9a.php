...
<div style="border:1px solid #ddd">
    <div style="background:#f5f5f5;padding:20px;position:relative">
        <h4>添加接口<span style="font-size:12px;padding-left:20px;color:#a94442">(注：接口编号、名称、请求地址为必填项)</span></h4>
        <div style="margin-left:20px;">
            <form action="<?php echo U('Interface/addInterfaceAction');?>" method="post" id="form">
                <h5>基本信息</h5>
                <div class="form-group has-error">
                    <div class="input-group">
                        <div class="input-group-addon">接口编号</div>
                        <input type="text" class="form-control" name="num" placeholder="接口编号" required="required" value="<?php echo ($code); ?>">
                    </div>
                </div>
                <div class="form-group has-error">
                    <div class="input-group">
                ...
                <div class="form-group has-error">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="url" placeholder="请求地址" required="required" value="http://">
                    </div>
                </div>
                <div class="form-group">
                    <textarea name="des" class="form-control" placeholder="简要描述"></textarea>
                </div>
                <div class="form-group">
                    <h5>请求参数</h5>
                    <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" name="p[mode][]">
                                        <option value="0">POST/GET</option>
                                        <option value="1">POST</option>
                                        <option value="2">GET</option>
                                    </select>
                                </td>
                                <td>
                                    <input type="text" class="form-control" name="p[order][]" placeholder="排序值(0),越大越靠前">
                                </td>
                                <td class="form-group has-error">
                                    <textarea name="p[des][]" rows="1" class="form-control" placeholder="描述, 含缺省值说明"></textarea>
                                </td>
                                <td>
                ...
                <div class="form-group">
                    ...
                    <textarea name="re" rows="3" class="form-control" id="re" ></textarea>
                </div>
                <div class="form-group">
                    <h5>返回值说明</h5>
                    <table class="table">
                        ...
                        <tbody id="return_value">
                            <tr>
                                <td class="form-group has-error">
                                    <input type="text" class="form-control" name="r[value][]" placeholder="返回参数">
                                </td>
                                <td class="form-group has-error">
                                    <input type="text" class="form-control" name="r[detail][]" placeholder="简要说明">
                                </td>
                                <td>
                                    <input type="text" class="form-control" name="r[order][]" placeholder="排序值(0),越大越靠前">
                                </td>
                                <td>
                ...
                <div class="form-group">
                    <h5>备注</h5>
                    <textarea name="memo" rows="3" class="form-control" placeholder="备注信息"></textarea>
                </div>
                <input type="hidden" name="cid" value="<?php echo ($_GET['cid']); ?>" />
                <button type="button" class="btn btn-success" id="submitbutton">Add !</button>
            </form>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function checkSubmit() {
        $.ajax({
            url: "<?php echo U('Interface/addInterfaceAction');?>",
            type: "POST",
            data: $('#form').serialize(),
            dataType: "text",
            success: function(re) {
