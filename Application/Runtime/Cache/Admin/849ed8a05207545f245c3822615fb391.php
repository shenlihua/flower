...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 启动图管理 <span class="c-gray en">&gt;</span> 启动图列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a href="<?php echo U('startAdd');?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加启动图</a>
		</span>
	</div>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort" id="layer-photos">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
				...
				<td><?php echo image($vo['img'],$i);?></td>
				<td><?php echo ($vo['sort']); ?></td>
				<td><?php echo date("Y-m-d H:i:s",$vo['update_time']);?></td>
				<td><?php echo $vo['status']==1?'显示':'关闭';?></td>
				<td class="td-manage">
                    <a href="<?php echo U('startAdd',array('id'=>$vo['img_id']));?>">编辑</a>
					<a style="text-decoration:none" onClick="member_stop(this,<?php echo ($vo['img_id']); ?>)" href="javascript:;" title="停用">停用</a>
					<a title="删除" href="javascript:;" onclick="member_del(this,<?php echo ($vo['img_id']); ?>)" class="ml-5" style="text-decoration:none">删除</a>
				</td>
...
function member_stop(obj,id){
	...
	layer.confirm('确认要'+content+'吗？',function(index){
		$.get("<?php echo U('opAction');?>",{id:id},function(result){
