...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 管理员管理 <span class="c-gray en">&gt;</span> 管理员列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a href="<?php echo U('manageAdd');?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a>
		</span>
	</div>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort" id="layer-photos">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                ...
                <?php if($vo['type'] == 0): ?><td>超级管理员</td>
                <?php else: ?>
                    <td><?php echo $roles[$vo['role']];?></td><?php endif; ?>

                <td><?php echo $vo['status']==1?'启用':'禁用';?></td>

                <?php if($vo['type']): ?><td class="td-manage">
					<a style="text-decoration:none" onClick="member_stop(this,<?php echo ($vo['id']); ?>)" href="javascript:;" ><?php echo $vo['status']==1?'禁用':'启用';?></a>
					<a style="text-decoration:none" href="<?php echo U('manageAdd',array('id'=>$vo['id']));?>" >编辑</a>
					<a title="删除" href="javascript:;" onclick="member_del(this,<?php echo ($vo['id']); ?>)" class="ml-5" style="text-decoration:none">删除</a>
				</td>
                <?php else: ?>
                    <td></td><?php endif; ?>
...
function member_stop(obj,id){
	...
	layer.confirm('确认要'+content+'吗？',function(index){
		$.get("<?php echo U('operateManage');?>",{id:id},function(result){
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.get("<?php echo U('delManage');?>",{id:id},function(result){
			layer.msg(result['msg']);
			if(result['code']){
