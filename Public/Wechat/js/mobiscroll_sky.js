    ...
    function Scroller(elem, settings) {
        ...
        function generateWheelItems(i) {
            ...
            for (j in warr[i]) {
                ...
                html += '<div class="dw-li dw-v" data-val="' + j + '" style="height:' + hi/10 + 'rem;line-height:' + hi/10 + 'rem;"><div class="dw-i">' + warr[i][j] + '</div></div>';
                l++;
            }
            html += '</div>';
            return html;
...
//			window.shengri = elm.val().substr(0,4);
            that.setValue(true);
        }
...
//                      alert(v)
        ...
        */
        that.scroll = function (t, index, val, time, orig) {
            ...
            t.attr('style', (prefix + '-transition:all ' + (time ? time.toFixed(3) : 0) + 's ease-out;') + (has3d ? (prefix + '-transform:translate3d(0,' + px/10 + 'rem,0);') : ('top:' + px/10 + 'rem;')));
        ...
        that.show = function (prevAnim) {
            ...
            for (i = 0; i < s.wheels.length; i++) {
                ...
                for (label in s.wheels[i]) {
                    ...
                    html += '<td><div class="dwwl dwrc dwwl' + l + '">' + (s.mode != 'scroller' ? '<div class="dwwb dwwbp" style="height:' + hi/10 + 'rem;line-height:' + hi/10 + 'rem;"><span>+</span></div><div class="dwwb dwwbm" style="height:' + hi/10 + 'rem;line-height:' + hi/10 + 'rem;"><span>&ndash;</span></div>' : '') + '<div class="dwl">' + label + '</div><div class="dww" style="height:' + (s.rows * hi)/10 + 'rem;min-width:' + s.width/10 + 'rem;"><div class="dw-ul">';
                    // Create wheel values
